#!/usr/bin/env python3
"""
Run combined forward scorecard V2 with the independent Kalshi rollover probe.
...
import BTC15_KALSHI_ROLLOVER_DISCOVERY_PROBE_V1 as probe


def main() -> int:
    probe.start_probe_thread()
    print(
        "BTC15 COMBINED V2 + ROLLOVER PROBE | READ ONLY | "
        "BROAD status=open VS EXACT NEXT TICKER | NO ORDERS",
        flush=True,
    )
