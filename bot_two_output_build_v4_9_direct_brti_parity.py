...
# ============================================================
_snapshot_log = Path('kalshi_two_output_live_log_v4_9.csv')
_snapshot_fields = [
...
print("\n" + "="*72)
print("V4.9 TRUE SCALP + EARLY-CONF + DIRECT-BRTI PARITY MODULE STARTING")
print("FINAL + TIER-1 ABOVE: PRESERVED")
print("TARGET LOOKUP FIX: INSTALLED")
print("NEW SCALP TARGET: MATERIAL TEMPORARY MOVES")
print("DIRECT BRTI: PARITY SHADOW ONLY — EXISTING FINAL GATE UNCHANGED")
print("="*72)
...
ensure_csv(BRTI_PARITY_LOG, BRTI_PARITY_FIELDS)
