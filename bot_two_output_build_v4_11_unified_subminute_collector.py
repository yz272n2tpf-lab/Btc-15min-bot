...
# ============================================================
_snapshot_log = Path('kalshi_two_output_live_log_v4_11.csv')
_snapshot_fields = [
...
print("\n" + "="*72)
print("V4.11 TRUE SCALP + DIRECT-BRTI + UNIFIED SUBMINUTE COLLECTOR STARTING")
...
UNIFIED_SUBMINUTE_LOG = Path("kalshi_subminute_unified_v1.csv")
...
def log_unified_subminute(
    ...
    for side in ("UP","DOWN"):
        ...
        broad_candidate = bool(
            240.0 <= float(seconds_left) <= 600.0
        ...
        row = {
            ...
            "preferred_fair_side": fair_live.get("side"),
            "preferred_fair": fair_live.get("fair"),
            "preferred_edge": fair_live.get("edge"),
            "current_target_side": current_target_side,
            "preferred_side_match": bool(
                fair_live.get("side") == side
            ),
            "dist_over_range5": fair_live.get("dist_over_range5"),
            "range5": fair_live.get("range5"),
            "vol5": fair_live.get("vol5"),
            ...
            if _unified_rows:
                _pref = next(
                    (
                        ...
                        if r["side"] == r["preferred_fair_side"]
                    ),
                    _unified_rows[0],
                )
                print(
                    ...
                    f"fair {_pref['side_fair']:.1%} | "
                    f"edge {_pref['side_edge']:+.1%} | "
