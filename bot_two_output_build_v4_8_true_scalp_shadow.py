...
# ============================================================
_snapshot_log = Path('kalshi_two_output_live_log_v4_8.csv')
_snapshot_fields = [
...
# =====================================================================
# V4.8 TRUE SCALP SHADOW — NEW SCALP DEFINITION
# =====================================================================
# IMPORTANT:
# - FINAL authority above is unchanged from V4.7 / V4.6 tournament winner.
# - Tier-1 ENTRY rule above is unchanged from V4.7.
# - The old 1m/5m "scalp score" and its backtest have been REMOVED.
# - This new scalp module is SHADOW DATA COLLECTION ONLY.
# - It looks for meaningful temporary contract-price moves, not 1-2c noise.
# - Both UP and DOWN are evaluated independently of final settlement.
# - Entry measurement = actual Kalshi ASK.
# - Forward executable exit measurement = actual Kalshi BID.
# - Material research targets = +8c / +10c / +15c / +20c.
# - Poll cadence = 5 seconds; forward horizon = 3 minutes.
# - NO ORDERS.
# =====================================================================

print("\n" + "="*72)
print("V4.8 TRUE SCALP SHADOW MODULE STARTING")
print("FINAL + TIER-1 ABOVE: PRESERVED")
print("OLD SCALP LOGIC: REMOVED")
...
from pathlib import Path
from datetime import datetime, timezone
import time, base64, csv, json, math, signal, sys
...
while running:
    ...
    try:
        ...
        target = num(market.get("floor_strike"))
        ...
        if target is None or close_dt is None:
            raise RuntimeError("Active market missing target/clock")
