...
Captured: 2026-09-16T23:31:57.905392+00:00

Status: **EARLY_DATA**. Winner selected: **No**. No promotion.

Eligible full contracts: **3**; serial signals: **6**.
Remaining to overall review floor: 97 contracts / 94 signals. Per-lane sufficiency is not established.
...
| candidate_verify_v2 / V2_DYNAMIC_CAUSAL | V1_IMMEDIATE | 2 | 1 / 1 | 4 | -1.500 | 0.000 | 0.000 |
| candidate_verify_v2 / V2_DYNAMIC_CAUSAL | V1_FIXED_5S | 2 | 1 / 1 | 4 | 0.000 | 0.000 | 0.000 |
| candidate_verify_v2 / V2_DYNAMIC_CAUSAL | V1_FIXED_10S | 2 | 1 / 1 | 4 | 0.000 | 0.000 | 0.000 |
| candidate_verify_v2 / V2_DYNAMIC_CAUSAL | V1_FIXED_15S | 2 | 1 / 1 | 4 | 0.000 | 0.000 | 0.000 |
| candidate_verify_v2 / V2_DYNAMIC_CAUSAL | V1_FIXED_30S | 2 | 0 / 0 | 4 | 12.500 | — | — |
| selective_pullback_v2 / V2_BALANCED | V1_IMMEDIATE_CONTROL | 2 | 2 / 2 | 4 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_BALANCED | V1_LE50_30S | 1 | 1 / 1 | 0 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_BALANCED | V1_LE50_60S | 1 | 1 / 1 | 0 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_BALANCED | V1_LE40_30S | 1 | 1 / 1 | 0 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_BALANCED | V1_LE40_60S | 1 | 1 / 1 | 0 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_BALANCED | V1_LE35_30S | 0 | 0 / 0 | 0 | — | — | — |
| selective_pullback_v2 / V2_BALANCED | V1_LE35_60S | 0 | 0 / 0 | 0 | — | — | — |
| selective_pullback_v2 / V2_PRICE_DISCIPLINED | V1_IMMEDIATE_CONTROL | 1 | 1 / 1 | 5 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_PRICE_DISCIPLINED | V1_LE50_30S | 1 | 1 / 1 | 0 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_PRICE_DISCIPLINED | V1_LE50_60S | 1 | 1 / 1 | 0 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_PRICE_DISCIPLINED | V1_LE40_30S | 1 | 1 / 1 | 0 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_PRICE_DISCIPLINED | V1_LE40_60S | 1 | 1 / 1 | 0 | 0.000 | 0.000 | 0.000 |
