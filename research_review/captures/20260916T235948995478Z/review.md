...
Captured: 2026-09-16T23:59:48.992184+00:00

Status: **EARLY_DATA**. Winner selected: **No**. No promotion.

Eligible full contracts: **5**; serial signals: **8**.
Remaining to overall review floor: 95 contracts / 92 signals. Per-lane sufficiency is not established.
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| scalp2_economics_v2 / AFFORDABLE_LE50 | CONTROL_V1_SCALP2 | 0 | 0 / 0 | 2 | — | — | — |
| scalp2_economics_v2 / EARLY_AFFORDABLE | CONTROL_V1_SCALP2 | 0 | 0 / 0 | 2 | — | — | — |
| scalp2_economics_v2 / STRONG_AFFORDABLE | CONTROL_V1_SCALP2 | 0 | 0 / 0 | 2 | — | — | — |
| candidate_verify_v2 / V2_DYNAMIC_CAUSAL | V1_IMMEDIATE | 2 | 1 / 1 | 6 | -1.500 | 0.000 | 0.000 |
| candidate_verify_v2 / V2_DYNAMIC_CAUSAL | V1_FIXED_5S | 2 | 1 / 1 | 6 | 0.000 | 0.000 | 0.000 |
| candidate_verify_v2 / V2_DYNAMIC_CAUSAL | V1_FIXED_10S | 2 | 1 / 1 | 6 | 0.000 | 0.000 | 0.000 |
| candidate_verify_v2 / V2_DYNAMIC_CAUSAL | V1_FIXED_15S | 2 | 1 / 1 | 6 | 0.000 | 0.000 | 0.000 |
| candidate_verify_v2 / V2_DYNAMIC_CAUSAL | V1_FIXED_30S | 2 | 0 / 0 | 6 | 12.500 | — | — |
| selective_pullback_v2 / V2_BALANCED | V1_IMMEDIATE_CONTROL | 3 | 2 / 2 | 5 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_BALANCED | V1_LE50_30S | 2 | 1 / 1 | 0 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_BALANCED | V1_LE50_60S | 2 | 1 / 1 | 1 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_BALANCED | V1_LE40_30S | 2 | 1 / 1 | 0 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_BALANCED | V1_LE40_60S | 2 | 1 / 1 | 0 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_BALANCED | V1_LE35_30S | 1 | 0 / 0 | 0 | -4.000 | — | — |
| selective_pullback_v2 / V2_BALANCED | V1_LE35_60S | 1 | 0 / 0 | 0 | -4.000 | — | — |
| selective_pullback_v2 / V2_PRICE_DISCIPLINED | V1_IMMEDIATE_CONTROL | 2 | 1 / 1 | 6 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_PRICE_DISCIPLINED | V1_LE50_30S | 2 | 1 / 1 | 0 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_PRICE_DISCIPLINED | V1_LE50_60S | 2 | 1 / 1 | 1 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_PRICE_DISCIPLINED | V1_LE40_30S | 2 | 1 / 1 | 0 | 0.000 | 0.000 | 0.000 |
| selective_pullback_v2 / V2_PRICE_DISCIPLINED | V1_LE40_60S | 2 | 1 / 1 | 0 | 0.000 | 0.000 | 0.000 |
...
| --- | --- | ---: | ---: | ---: | ---: |
| V2_CONFIRMED_HALF_C | V1_1C | 2 / 2 | -0.959 | 0 / 0 | 1 / 0 |
| V2_CONFIRMED_HALF_C | V1_2C | 2 / 2 | 29.049 | 1 / 0 | 1 / 0 |
| V2_CONFIRMED_HALF_C | V1_3C | 2 / 2 | 29.049 | 1 / 0 | 1 / 0 |
