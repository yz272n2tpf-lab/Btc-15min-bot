...
def read_mixed_csv(path):
    # The live file has had schema changes over time.
    # First try the normal fast parser. If that fails, fall back to the
    # Python parser and skip malformed mixed-schema rows.
    try:
