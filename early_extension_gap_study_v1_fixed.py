...
if eligible.empty:
    eligible=r.copy()
    quality_note="NO candidate reached 3 validation calls; showing best available validation-only candidate."
else:
    quality_note=quality_note if "quality_note" in locals() else "Winner selected ONLY among >=90% accuracy / >=5-call validation candidates."
