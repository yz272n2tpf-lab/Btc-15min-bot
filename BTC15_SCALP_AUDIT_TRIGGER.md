...
2026-09-15 temporary Railway snapshot trigger: retired BTC30 observer is being used once to run the separately frozen direct-BRTI Flip Risk V1 unit tests and historical study. This line changes no BTC30 hypothesis, signal rule, threshold, production behavior, or order path.
