...
# Do not promote weak raw forecasts as actionable opportunities.
if _opportunity_ask is None:
    _opportunity_status = "WATCH"
    _opportunity_reason = "Waiting for live Kalshi ask"
elif _opportunity_ask > 0.50:
    _opportunity_status = "WAIT"
    _opportunity_reason = "Preferred-side Kalshi ask is above 50 cents"
elif _opportunity_edge is None or _opportunity_edge <= 0:
    _opportunity_status = "WAIT"
    _opportunity_reason = "No positive model edge versus the live ask"
else:
    _opportunity_status = "OPPORTUNITY"
    _opportunity_reason = (
        "Positive model edge at an ask of 50 cents or less; NOT a final call"
    )
