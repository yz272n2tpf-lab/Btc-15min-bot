#!/usr/bin/env python3
"""Off-production V13 dashboard shadow using clean combined SCALP UI V7. NO ORDERS."""
import btc15_combined_dashboard_shadow_v1 as base
from BTC15_DASHBOARD_COMBINED_SCALP_UI_V7 import build_dashboard
...
def main():
    print("BTC15 COMBINED DASHBOARD SHADOW V3 | CLEAN SCALP UI V7 | SCOPED MAIN TIMER AUTHORITY | NO ORDERS", flush=True)
    return base.main()
